...
### cURL:
```bash
curl -X GET "https://carwale-backend.oriserve.com/callFunnelAnalytics?campaign_id=507f1f77bcf86cd799439013&start_date=2024-01-01T00:00:00Z" \
...
async function getCallFunnelAnalytics(filters) {
  const response = await axios.get(
    'https://carwale-backend.oriserve.com/callFunnelAnalytics',
    {
      params: filters,
      headers: {
...
def visualize_funnel(campaign_id):
    url = "https://carwale-backend.oriserve.com/callFunnelAnalytics"
