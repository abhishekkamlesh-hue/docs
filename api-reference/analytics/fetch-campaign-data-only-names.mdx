...
const response = await fetch('https://carwale-backend.oriserve.com/fetchCampaignDataOnlyNamesAndAll', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://carwale-backend.oriserve.com/fetchCampaignDataOnlyNamesAndAll',
    headers={
        'Accept': 'application/json, text/plain, */*',
        'Origin': 'https://carwale-backend.oriserve.com/'
    }
...
```bash cURL
curl 'https://carwale-backend.oriserve.com/fetchCampaignDataOnlyNamesAndAll' \
  -H 'Accept: application/json, text/plain, */*' \
  -H 'Origin: https://carwale-backend.oriserve.com/' \
