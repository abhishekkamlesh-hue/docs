...
const response = await fetch('https://carwale-backend.oriserve.com/auditCall', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://carwale-backend.oriserve.com/auditCall',
    json={
        'callId': 'call-uuid-abc123',
...
```bash cURL
curl -X POST https://carwale-backend.oriserve.com/auditCall \
