...
```bash
curl -X POST "https://carwale-backend.oriserve.com/initiateCall" \
...
async function initiateCall(
  ...
  try {
    ...
    const response = await axios.post(
      "https://carwale-backend.oriserve.com/initiateCall",
      payload,
      {
        headers: {
...
def initiate_call(campaign_id, user_name, user_phone_number, meta_data=None, notification_webhook_url=None):
    url = "https://carwale-backend.oriserve.com/initiateCall"
