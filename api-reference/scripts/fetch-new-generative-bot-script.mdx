...
const response = await fetch('https://carwale-backend.oriserve.com/fetchNewGenerativeBotScript', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://carwale-backend.oriserve.com/fetchNewGenerativeBotScript',
...
```bash cURL
curl -X POST https://carwale-backend.oriserve.com/fetchNewGenerativeBotScript \
