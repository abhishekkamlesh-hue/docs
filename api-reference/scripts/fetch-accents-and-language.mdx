...
### cURL:
```bash
curl -X GET "https://carwale-backend.oriserve.com/fetchAccentsAndLanguageFromBackendServer" \
...
async function getAvailableVoices() {
  const response = await axios.get(
    'https://carwale-backend.oriserve.com/fetchAccentsAndLanguageFromBackendServer',
    {
      headers: {
