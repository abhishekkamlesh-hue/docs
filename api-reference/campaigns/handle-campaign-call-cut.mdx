...
const response = await fetch('https://carwale-backend.oriserve.com/handleCampaignCallCut', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://carwale-backend.oriserve.com/handleCampaignCallCut',
    json={
        'callId': 'call-uuid-abc123',
        'callDuration': 125,
...
```bash cURL
curl -X POST https://carwale-backend.oriserve.com/handleCampaignCallCut \
