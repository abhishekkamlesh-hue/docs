...
<ParamField header="Origin" type="string" required>
  ...
  Example: `https://carwale-backend.oriserve.com/`
</ParamField>
...
```bash cURL
curl --request POST \
  --url https://carwale-backend.oriserve.com/auth/login \
  --header 'Content-Type: application/json' \
  --header 'Origin: https://carwale-backend.oriserve.com/' \
  --data '{
...
const response = await fetch('https://carwale-backend.oriserve.com/auth/login', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
    'Origin': 'https://carwale-backend.oriserve.com/'
  },
  credentials: 'include',
  body: JSON.stringify({
    email: 'user@example.com',
