...
```bash cURL
curl --request GET \
  --url 'https://carwale-backend.oriserve.com/startCampaign/{campaignId}'
```
...
fetch(`https://carwale-backend.oriserve.com/startCampaign/${campaignId}`, options)
...
url = f"https://carwale-backend.oriserve.com/startCampaign/{campaign_id}"
