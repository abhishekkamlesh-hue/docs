...
```bash cURL
curl --request GET \
  --url 'https://carwale-backend.oriserve.com/deleteCampaign/{campaignId}'
```
...
fetch(`https://carwale-backend.oriserve.com/deleteCampaign/${campaignId}`, options)
...
url = f"https://carwale-backend.oriserve.com/deleteCampaign/{campaign_id}"
