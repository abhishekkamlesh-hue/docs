...
```bash cURL
curl --request GET \
  --url 'https://carwale-backend.oriserve.com/fetchCampaignData?limit={limit}&offset={offset}&call_count={call_count}' \
...
fetch(`https://carwale-backend.oriserve.com/fetchCampaignData?limit=${limit}&offset=${offset}&call_count=${callCount}`, options)
...
url = "https://carwale-backend.oriserve.com/fetchCampaignData"
...
$url = "https://carwale-backend.oriserve.com/fetchCampaignData?limit=10&offset=0&call_count=true";
