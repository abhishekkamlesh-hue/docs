...
```bash cURL
curl --request GET \
  --url 'https://carwale-backend.oriserve.com/getCampaignStats/{campaignId}'
```
...
fetch(`https://carwale-backend.oriserve.com/getCampaignStats/${campaignId}`, options)
...
url = f"https://carwale-backend.oriserve.com/getCampaignStats/{campaign_id}"
