...
```bash cURL
curl --request GET \
  --url 'https://carwale-backend.oriserve.com/pauseTheCampaign/{campaignId}'
```
...
fetch(`https://carwale-backend.oriserve.com/pauseTheCampaign/${campaignId}`, options)
...
url = f"https://carwale-backend.oriserve.com/pauseTheCampaign/{campaign_id}"
