...
<Response>
  ...
  <GetDigits 
    action="https://carwale-backend.oriserve.com/ivr-menu" 
    method="POST"
    numDigits="1"
    timeout="10"
    finishOnKey="#">
...
<Response>
  ...
  <GetInput 
    action="https://carwale-backend.oriserve.com/responseHook"
    method="POST"
    inputType="speech"
    timeout="10"
    maxSpeechTime="60"
    speechTimeout="5"
    interimSpeechResultsCallback="https://carwale-backend.oriserve.com/interim-results">
...
<Response>
  ...
  <Record 
    action="https://carwale-backend.oriserve.com/voicemail"
    method="POST"
    maxLength="120"
    timeout="10"
    finishOnKey="#"
    recordSession="false"
    redirect="true"
    callbackUrl="https://carwale-backend.oriserve.com/recording-status"
    callbackMethod="POST" />
...
### cURL Example:
```bash
curl -X POST https://carwale-backend.oriserve.com/oriIncomingCallHandler \
